...
- `lanelet2/basic_intersection_area.osm`: Lanelet2 input for OpenDRIVE, OSM
  and raster output.
...
maps run Lanelet2 -> OpenDRIVE, Lanelet2 -> OSM and Lanelet2 -> Raster;
OpenDRIVE maps run OpenDRIVE -> Lanelet2 and OpenDRIVE -> OSM; OSM maps run
OSM -> Lanelet2 and OSM -> OpenDRIVE. Each case writes its target map and
diagnostic reports to the workflow artifact.
