...
OUTPUT_DIR = PROJECT_ROOT / "data" / "results" / "opendrive_to_lanelet2"
TARGET = OUTPUT_DIR / "commonroad_straight_road.osm"


def main() -> None:
    result = convert_and_diagnose(SOURCE, TARGET, "opendrive", "lanelet2", diagnostics_dir=OUTPUT_DIR)
    ...
    #     "--output-dir", "data/results/opendrive_to_lanelet2_batch",
    # ])
