"""Diagnostic profile for the OSM -> Lanelet2 workflow."""
...
from ._workflow_runtime import ConversionSpec, convert_osm_to_lanelet2, validate_lanelet2_target

CONVERSION = "osm_to_lanelet2"
...
def create_spec(source_path: Path, target_path: Path) -> ConversionSpec:
    ...
    return ConversionSpec(
        ...
        source_suffix=".osm",
        target_suffix=".osm",
        convert=convert_osm_to_lanelet2,
        validate=validate_lanelet2_target,
    )


def diagnose_osm_to_lanelet2(
