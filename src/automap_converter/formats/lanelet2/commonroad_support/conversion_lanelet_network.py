...
from automap_converter.formats.lanelet2.commonroad_support import geometry
from automap_converter.formats.lanelet2.commonroad_support.conversion_lanelet import ConversionLanelet
from automap_converter.formats.lanelet2.commonroad_support.utils import (
...
class ConversionLaneletNetwork(LaneletNetwork):
    ...
    def _concatenate_lanelet_pairs_group(
        ...
        for pair in lanelet_pairs:
            ...
            lanelet_1.opendrive_lane_locations = set(
                getattr(lanelet_1, "opendrive_lane_locations", set())
            ) | set(getattr(lanelet_2, "opendrive_lane_locations", set()))
            lanelet_1.opendrive_lane_locations_detailed = set(
                getattr(lanelet_1, "opendrive_lane_locations_detailed", set())
            ) | set(getattr(lanelet_2, "opendrive_lane_locations_detailed", set()))
