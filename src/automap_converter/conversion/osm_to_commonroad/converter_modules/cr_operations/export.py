...
from automap_converter.conversion.osm_to_commonroad.converter_modules.intermediate_operations.intermediate_format._intermediate_format import (
    IntermediateFormat,
)
from automap_converter.conversion.osm_to_commonroad.converter_modules.utility.geonamesID import (
    get_geonamesID,
)
